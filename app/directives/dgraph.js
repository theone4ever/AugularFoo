demoApp.directive('dGraph', ['$window', '$timeout', 'd3',
        ...
        return {
            ...
            link: function (scope, ele, attrs) {
                ...
                scope.render = function (dataset) {
                    if (!dataset.dataset||!dataset.config) return;
                    var maxLineChars = 26,
                        wrapChars = ' /_-.'.split('');
                    ...
                    function drawGraph() {
                        ...
                        $('#graph-container').on('dblclick', function (e) {
                            if (!$(e.target).closest('.node').length) {
                                alert("hello");
                            }
                        });
